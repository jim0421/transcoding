...
#define FFMPEG_CONFIGURATION "--enable-shared --enable-libfaac --enable-libx264 --enable-gpl --enable-nonfree --enable-yasm --enable-debug --enable-decoder=aac --enable-encoder=aac --enable-parser=aac --extra-cflags=-g --extra-ldflags=-g"
